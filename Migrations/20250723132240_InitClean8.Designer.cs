...
namespace radio_waves.Migrations
{
    ...
    [Migration("20250723132240_InitClean8")]
    partial class InitClean8
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("radio_waves.Models.InsuranceCompanySettlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InsuranceCompanySettlements");
                });
            ...
            modelBuilder.Entity("radio_waves.Models.PartnerServices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("radio_waves.Models.Insurance", b =>
                {
                    b.HasOne("radio_waves.Models.InsuranceCompanies", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("radio_waves.Models.PartnerServices", b =>
                {
                    b.HasOne("radio_waves.Models.Partner", "Partner")
                        .WithMany()
                        .HasForeignKey("PartnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("radio_waves.Models.RadiologyType", "Service")
                        .WithMany()
