...
namespace radio_waves.Migrations
{
    ...
    [Migration("20250624090133_Parteners")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("radio_waves.Models.InsuranceBreakdown", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TechnicianSettlementViewModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TechnicianSettlementViewModelId");

                    b.ToTable("InsuranceBreakdown");
                });
            ...
            modelBuilder.Entity("radio_waves.Models.TechnicianSettlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TotalDebtShare")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalExpenses")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalFromInsurance")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalFromReservations")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("TechnicianSettlements");
                });

            modelBuilder.Entity("radio_waves.Models.TechnicianSettlementViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("SettelmentDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("TechnicianSettlementViewModel");
                });
            ...
            modelBuilder.Entity("radio_waves.Models.InsuranceBreakdown", b =>
                {
                    b.HasOne("radio_waves.Models.TechnicianSettlementViewModel", null)
                        .WithMany("InsuranceDetails")
                        .HasForeignKey("TechnicianSettlementViewModelId");
                });
