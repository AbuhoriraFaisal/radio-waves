...
namespace radio_waves.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PartnerName,Comment,Active")] Partner partner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PartnerName,Comment,Active")] Partner partner)
        {
            if (id != partner.Id)
            {
                return NotFound();
